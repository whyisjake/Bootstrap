pass:[<prefaceinfo><author><firstname>Dave</firstname><surname>Winer</surname></author>   <affiliation><emphasis>editor,</emphasis> Scripting News<emphasis>, January 2013, New York</emphasis></affiliation></prefaceinfo>
]
[preface]
