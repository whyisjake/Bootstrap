...
If you need to disable a single plugin, you can do it programmatically using the namespace of the plug-in along with the `data-api` namespace(((JavaScript plug-ins, disabling))):
