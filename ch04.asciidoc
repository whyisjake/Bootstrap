...
The collapse plugin makes it easy to make collapsing divisions of the page (see <<accordionfig>>. Whether you use it to build accordion navigation or content boxes, it allows for a lot of content options. and <<accordioncode>>.(((JavaScript plugins, collapse)))(((collapsing page divisions)))(((accordion navigation)))
