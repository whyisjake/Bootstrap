...
In particular, the following default styles give special treatment to typography and links(((typography, default styles for)))(((links, default styles for)))((("fonts", seealso="typography"))):
