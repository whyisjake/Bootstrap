...
// it seemed like this para belonged in the unordered list section, so i moved it. I also tagged it as a note, because it felt like a note to me, but feel free to change. -NM
