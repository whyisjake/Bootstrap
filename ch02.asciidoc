...
In the case of the `<h1>`, the small text is 24 pixels tall, normal font weight (i.e., not bold), and gray instead of black.(((typography, headings)))(((headings)))(((inline subheadings)))
