...
The classes shown in <<table2-2>> will allow you to change the background color of your rows(((range="endofrange", startref="ix_CSStabl"))) (see <<figure2-18>>).
