...
Bootstrap bundles 140 icons into one sprite that can be used with buttons, links, navigation, and form fields. The icons are provided by http://glyphicons.com/[GLYPHICONS] (see <<figure2-48>>).((("CSS (Cascading Style Sheets)", "icons")))(((icons)))(((GLYPHICONS)))
