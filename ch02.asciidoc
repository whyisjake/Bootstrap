...
.Heads Up!
NOTE: If you would like to have a `<blockquote>` with content that is `right-aligned`, simply add `.pull-right` to the tag. In addition to the right-aligned text, the entire `blockquote` is floated to the right. This will create nice pull-quotes in a your content.
