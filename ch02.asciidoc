...
// just tidied up some of the phrasing throughout this chap. -NM
...
For italics, wrap your content in the `<em>` tag. The root of em, is to add emphasis or stress to your text.
