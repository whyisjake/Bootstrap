...
The classes shown in <<table2-2>> will allow you to change the background color of your rows (see <<figure2-18>>).(((range="endofrange", startref="ix_CSStabl")))(((range="endofrange", startref="ix_tabls")))(((table row classes)))((("rows, changing color of")))
