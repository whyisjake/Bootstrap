...
One of my favorite features of Bootstrap is the way that buttons are styled. Dave Winer, inventor of RSS and big fan of Bootstrap, has this to say about it((("CSS (Cascading Style Sheets)", "buttons", id="ix_CSSbutt", range="startofrange"))):
