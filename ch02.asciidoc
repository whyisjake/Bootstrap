...
The most common form text field is the input--this is where users will enter most of the essential form data (see <<figure2-23>>). Bootstrap offers support for all native HTML5 input types: text, password, datetime, datetime-local, date, month, time, week, number, email, URL, search, tel, and color(((input types)))(((HTML5 input types))):
