...
With the default grid system that is inherent in Bootstrap, you can use the `.span*` system for sizing form controls. In addition to the span method, you can also use a handful of classes that take a relative approach to sizing. 
