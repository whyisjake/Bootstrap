  ...
  <li class="span4">
    <div class="thumbnail">
      ...
      <div class="caption">
        ...
        <p><a href="#" class="btn btn-primary">Bacon</a> <a href="#" class="btn">Sausage</a></p>
      </div>
    </div>
  </li>
  <li>
...
<div class="alert">
    ...
    <strong>Warning!</strong> Not to be alarmest, but you have now been alerted.
</div>
----
...
image::iamges/progress-bar-striped.png[]
...
image::images/progress-bar-stacked[]
...
When you look at social sites like Facebook, Twitter and others, strip away some of the formatting from timelinesm, and you will see the Media Object. Driven by the Bootstrap community, and based on principles from the oocss[http://oocss.org/] community, the goal of the media element is to make the code for developing these blocks drastically shorter. Nicole Sullivan-Hass shares a few elemement of the media object like this on her site:
...
There are two additional classes that can be used in conjuntion with `.well, `.well-large` and `.well-small`.
