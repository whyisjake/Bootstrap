...
Navigation menus share a similar syntax with dropdown menus. By default, you have a list item that has an anchor that works in conjuntion with some `data-` attributes to trigger an unodered list with a `.dropdown-menu` class.
