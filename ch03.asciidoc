...
There are a few more Bootstrap components that we have yet to cover in this chapter. Some of these components are layout based, and a few are production based helper clasees. The first among these are the wells.
