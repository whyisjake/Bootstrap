...
Both tabs and pills are horizontal by default. To make them appear vertically stacked, just add the `.nav-stacked` class. See Figures pass:[<xref linkend="figure3-12" xrefstyle="select: labelnumber">3-12</xref> and <xref linkend="figure3-13" xrefstyle="select: labelnumber">3-13 </xref>] for examples of verticaly stacked tabs and pills.(((navigation elements, stackable navigation)))(((stackable navigation)))
