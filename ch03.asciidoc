...
Badges are similar to labels, the primary difference is that the corners are more rounded corners. The colors of badges reflect the same classes as labels.
