...
Bootstrap provides a few different options for styling navigation elements. All of them share the same markup and base class, `.nav`.((("layout components", "navigation elements", id="ix_lcnavelm", range="startofrange")))
