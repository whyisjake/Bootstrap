...
To create a striped progress bar (see <<figure3-43>>), just add `.progress-striped` to the container `<div>`: 
...
Striped progress bars are not available in Internet Explorer 7 and 8.
