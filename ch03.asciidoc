...
To create a tabbed navigation menu, start with a basic unordered list with the base class of `.nav` and add `.nav-tabs`. See <<figure3-9>> for an example of a tabbed navigation menu.(((navigation elements, tabular)))(((tabular navigation)))
