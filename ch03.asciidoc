...
Like the striped version of the progress bar, you can animate the stripes (see <<figure3-44>> to show an image of this), making it look like a blue light special barbershop pole.
