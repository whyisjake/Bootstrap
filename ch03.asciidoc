...
Labels are great for offering counts, tips, or other markup for pages. Another one of my favorite little Bootstrap touches. <<figure3-33>> shows some labels that can be used.(((layout components, labels)))
