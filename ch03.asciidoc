...
To create an inverted navbar with a black background and white text, simply add `.navbar-inverse` to the `.navbar` class (see <<figure3-26>>).(((range="endofrange", startref="ix_lcnavbar")))
