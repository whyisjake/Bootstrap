...
To create a tabbed navigation menu, start with a basic unordered list with the base class of `.nav` and add `.nav-tabs`: (((navigation elements, tabular)))(((tabbed navigation)))
