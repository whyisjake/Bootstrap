...
To use media list, change the container `<div>` to an `<ul>` and add the class `.media-list`. Since you can nest media objects, it makes it handy to markup for comments or other lists.
