...
The purpose of progress bars is to show that assets are loading, in progress, or that there is action taking place regarding elements on the page. Personally, I think that these elements are just an exercise in markup and have little purpose beyond that in the Bootstrap framework. That being said, thousands of people using Bootstrap, there are likely a few outliers that have a good reason for building progress bars. By nature, these are static elements and need some sort of JavaScript method to provide any interaction.
