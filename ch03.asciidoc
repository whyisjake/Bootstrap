...
To have the checkboxes function as radio buttons, where only one option can be selected at a time, or checkboxes, where multiple can be selected, you simply need to add some extra markup and the Bootsrap's JavaScript will provide the rest. This will be covered in detail in chapter 4.
