...
To left/right align the links, you just need to add the `.previous` and `.next` class to the list-items. Also, like `.pagination` in Figure 3-30, you can add the disabled class for a muted look.
